...
{
    public class LibrianManageModel : PageModel
    {
        private readonly PRN221_LibContext PRN221_LibContext;

        public LibrianManageModel(PRN221_LibContext PRN221_LIBContext)
        {
        ...
        {
            IQueryable<User> usersQuery = PRN221_LibContext.Users.Where(x => x.Role == 3).Include(x => x.RoleNavigation);
